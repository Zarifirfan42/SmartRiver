      ...
      tooltip: {
        callbacks: {
          label(ctx) {
            ...
            if (v == null || Number.isNaN(v)) return 'WQI: —'
            let band = 'Clean'
            if (v < 60) band = 'Polluted'
            else if (v < 81) band = 'Slightly polluted'
            return [`WQI: ${Number(v).toFixed(1)}`, `Band: ${band} (81+ clean, 60–80 slight, <60 polluted)`]
          },
        },
      },
    },
