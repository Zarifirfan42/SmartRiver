    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-6">
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <p className="text-sm text-slate-500 flex items-center gap-2">
          <span className="text-lg" aria-hidden>📍</span> Stations in snapshot
        </p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <p className="text-sm text-slate-500 flex items-center gap-2">
          <span className="text-lg" aria-hidden>💧</span> Average WQI
        </p>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
        <p className="text-sm text-slate-500 flex items-center gap-2">
          <span className="text-lg" aria-hidden>🌿</span> Clean
        </p>
      ...
      <div className="rounded-xl border-2 border-amber-200 bg-amber-50/80 p-4 shadow-sm ring-1 ring-amber-100">
        <p className="text-sm font-medium text-amber-900 flex items-center gap-2">
          <span className="text-lg" aria-hidden>⚠️</span> Slightly polluted
        </p>
      ...
      >
        <p className={`text-sm flex items-center gap-2 ${pollutedCount > 0 ? 'font-medium text-red-900' : 'text-slate-500'}`}>
          <span className="text-lg" aria-hidden>🚨</span> Polluted
        </p>
