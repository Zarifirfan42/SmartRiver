...
def register_routes(app):
    ...
    try:
        ...
        pass
    try:
        from backend.controllers.warnings_controller import router as warnings_router
    ...
    try:
        ...
        pass
    try:
        from backend.controllers.compat_controller import router as compat_router
