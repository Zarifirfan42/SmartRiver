...
def run_backfill() -> None:
  ...
  policy_end = date(MAX_DOE_FORMULA_CSV_YEAR, 12, 31)
  backfill_end = min(today, policy_end)
  ...
  for station_key, rows in by_station.items():
    ...
    # Loop from earliest date up to yesterday (never past MAX_DOE_FORMULA_CSV_YEAR: 2026+ uses LSTM forecast).
